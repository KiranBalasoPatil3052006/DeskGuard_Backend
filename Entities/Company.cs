/// <summary>
        ...
        namespace DeskGuardBackend.Entities
        {
            public class Company
            {
                ...
                /// <summary>Unique customer identifier (e.g., CUST-001).</summary>
                ...
                /// <summary>AMC plan name.</summary>
                public string? AmcPlan { get; set; }

                /// <summary>AMC plan start date.</summary>
                public DateTime? AmcStartDate { get; set; }

                /// <summary>AMC plan end date.</summary>
