        ...
        try
        {
            ...
            dbContext.Database.ExecuteSqlRaw(@"
                CREATE TABLE IF NOT EXISTS customers (
                    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    customer_code character varying(100) NOT NULL DEFAULT '',
                    company_name character varying(255) NOT NULL DEFAULT '',
                    customer_name character varying(255) NOT NULL DEFAULT '',
                    mobile_number character varying(50) NOT NULL DEFAULT '',
